...
public class SistemaRegistro {
	...
	private HashMap<String,Profesor>Profesores; // Mapa que guarda todos los profesores con llave el id y con clave el profesor 
	private HashMap<String,Estudiante>Estudiantes; // Mapa que guarda todos los estudiantes con llave el id y clave el estudiante
	public HashMap<String,LearningPath> learningPaths; // Mapa que guarda todos los learningPaths con llave el id y con clave los learningPaths
	public HashMap<String, Actividad> actividades; // //Mapa que guarda todas las actividades con llave el id y con clave las actividades
